    ...
    constructor(props) {
      ...
      render () {
        ...
        if (!this.state.isEditing) {
          view = <LeagueProfileView league={league} handleTeamEdits={(e, teams) => this.handleTeamEdits(e, teams)} onClick={(e) => this.editToggle(e)} />;
        } else {
          view = <LeagueProfileEdit league={league} onClick={(e, name, date) => this.handleChangeStats(e, name, date)} onEditToggle={(e) => this.editToggle(e)}/>;
        }
